...
class Config(BaseConfig):
    def __init__(self):
        ...
        self.train_dataset = Zhang(self.data_root+'/zhanglab/train', train=True, img_size=(self.img_size, self.img_size))
        ...
        self.val_dataset = Zhang(self.data_root+'/zhanglab/val', train=False, img_size=(self.img_size, self.img_size), full=True)
        self.val_loader = torch.utils.data.DataLoader(self.val_dataset, batch_size=1, shuffle=False, num_workers=0, drop_last=False)

        self.test_dataset = Zhang(self.data_root+'/zhanglab/test', train=False, img_size=(self.img_size, self.img_size), full=True)
